...
4) NÄCHSTE AUFGABE (genau hier weitermachen):
   **B10 — Pressverband (DIN 7190)** – größter Physik-Baustein: Fugendruck p, Übertragbarkeit
   (Drehmoment/Axialkraft), Fügetemperatur/Fügespiel, Vergleichsspannung (v. Mises) gegen
   Streckgrenze, Sicherheiten. Neues Modul (z. B. `pressverband.js`), DOM-frei, mit selbst-
   prüfendem Rechenweg + Panels, i18n DE/EN/PT; externer Validierungsanker (WN1/Literatur) ±2 %.
   Für den Physik-Kern das stärkere Modell empfohlen. Bewährter Fließband-Ablauf (Abschnitt 0.4).
   (B9 komplett & am Handy bestätigt: Kostenampel, Messmittel, Oberfläche, Schmierspalt inkl.
   selbstprüfendem Rechenweg — Details im Changelog am Dateiende.)
...
═══════════════════════════════════════════════════════════════════════════
Plan-Version : 1.9.5 · Stand 2026-07-16 · Status: **B9 Beratungs-Module komplett (Kostenampel, Messmittel, Oberfläche, Schmierspalt + selbstprüfender Rechenweg), grün & am Handy bestätigt — Projektordner + GitHub aktuell** · nächster Baustein: B10
