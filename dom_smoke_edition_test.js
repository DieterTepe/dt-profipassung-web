/* DOM-Smoke Edition-Sicherheit (DEV-ONLY, nicht ausgeliefert)
...
global.DT_EDITION = 'vollzugang'; /* bewusst FALSCHER Wert: muss trotzdem Testversion ergeben */
...
console.log('\nDOM-Smoke Edition-Sicherheit: ' + okCount + ' OK, ' + failCount + ' Fehler');
